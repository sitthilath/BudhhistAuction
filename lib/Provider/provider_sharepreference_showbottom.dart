...
class AutoAuctionNotifier extends ChangeNotifier {
  ...
  _loadFromPrefs() async {
    await _initPrefs();
    _autoAuction = _prefs.getBool(key) ?? true;
    notifyListeners();
  }
...
class SelectSending extends ChangeNotifier {
...
class NotificationIfHasSomeoneAuctionMore extends ChangeNotifier{
  ...
  NotificationIfHasSomeoneAuctionMore() {
